...
heights_and_ages = heights + ages  # adding two lists.
heights_and_ages_arr = np.array(heights_and_ages)
# This will creat a single array of shape(90,0).
# print(heights_and_ages_arr.shape)
# This will creat a array of matrix of (2,45) here 2 column and 45 is row.
