# if we  want to both update height and age of the first president with new data, we can supply data in
# the list.
import numpy as np
...
heights_and_ages_arr[:, 0] = [190, 58]  # update height and age both
